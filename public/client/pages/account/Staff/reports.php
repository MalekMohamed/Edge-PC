    ...
    <div class="card-box">
        <div class="table-responsive">
            <table class="table text-center data-table table-hover table-bordered">
                ...
                <?php
                foreach ($app->getReports('All') as $item) {
                    $data['id'] = $item['item'];
                    $itemData = $app->get_items($data);
                    if (!empty($itemData)) {
                        ?>
                        <tr>
                            <td><?php echo $itemData['Name'] . '-' . numhash($itemData['ID']); ?></td>
                            <td><?php echo $item['category']; ?></td>
                            <td><?php echo $item['reason']; ?></td>
                            <td><?php echo $item['date']; ?></td>
                            <td><?php echo Store::reportsStates($item['status']); ?></td>
                            <td align="center">
                                <a href="<?php echo $app->BASE_URL('Products/' . numhash($itemData['ID'])); ?>"
                                   class="btn-inverse btn on-default" data-toggle="tooltip" data-placement="top"
                                   title="" data-original-title="View item"><i
                                        class="fa fa-eye"></i></a>
                    ...
                    <?php } else {
                       var_dump($app->updateReport($item['id'],2));
                    }
                }
                ?>
